...
const Eat = () => {
        ...
        return (
                <div className="w-full h-screen relative">
                        {agree === true ? (<div className="h-full flex flex-col items-center justify-center">{quantity > 0 && <h1 className="text-3xl text-center font-bold text-blue-500">Cảm on cậu đã đồng ý sau {quantity} từ chối</h1>}<img src="1.gif" alt="" /><h1 className="text-4xl text-center font-bold text-[#F70707]">Heheheheheheheheh</h1></div>) : (<div className="h-full flex flex-col items-center justify-center gap-12">
                                <h1 className="text-4xl text-center font-bold text-[#F70707]">Ăn đêm không?</h1>
                                <img src="6.gif" alt="" />
